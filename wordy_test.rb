...
# Added by me
  def test_3_operations
    question = 'What is -3 plus 7 multiplied by -2 minus 2?'
    assert_equal(-10, WordProblem.new(question).answer)
  end

  def test_4_operations
    question = 'What is -3 plus 7 multiplied by -2 minus 2 multiplied by -2?'
    assert_equal(20, WordProblem.new(question).answer)
  end
